...
if ! command -v aarch64-linux-gnu-gcc "-v" &> /dev/null; then
...
dir=build-aarch64-linux-gnu-10-3
mkdir -p $dir
cd $dir
...
cmake \
  ...
  -DCMAKE_TOOLCHAIN_FILE=../toolchains/aarch64-linux-gnu-10.3.toolchain.cmake \
  ..
